# zadania wykonane przez frontend-agnes.pl
...
:arrow_left: [*poprzedni zestaw zadań (**JavaScript: Podstawy - funkcje**)*](https://github.com/devmentor-pl/practice-js-basics-functions)
